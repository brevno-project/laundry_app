...
\restrict OTkJYvkxrMO3lvZ9fZJlRUPzu5NCh5OsQeoMm2AXw6DtAsm6ufnggV7Q94DHG9R
...
CREATE FUNCTION public.cleanup_expired_coupon_queue(p_grace_minutes integer DEFAULT 5) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
begin
...
CREATE TABLE public.students (
    ...
    key_lost boolean DEFAULT false NOT NULL,
    apartment_id uuid,
    avatar_style character varying(50) DEFAULT 'avataaars'::character varying,
...
--
-- Name: students Students can update their own avatar; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Students can update their own avatar" ON public.students FOR UPDATE USING ((auth.uid() = user_id)) WITH CHECK ((auth.uid() = user_id));
...
\unrestrict OTkJYvkxrMO3lvZ9fZJlRUPzu5NCh5OsQeoMm2AXw6DtAsm6ufnggV7Q94DHG9R
