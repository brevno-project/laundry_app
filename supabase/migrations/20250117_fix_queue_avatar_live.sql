-- Fix queue avatars to always use live data from students table instead of snapshot
-- This ensures avatars are always up-to-date without manual updates
...
BEGIN
  ...
  SELECT
    ...
    q.queue_date,
    q.queue_position,
    -- ✅ ИСПРАВЛЕНО: Всегда берем актуальные данные из students, а не snapshot из queue
