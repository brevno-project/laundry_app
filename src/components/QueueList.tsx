      ...
      {showEditModal && editingItem && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          ...
          <select
            ...
            className="w-full border-2 border-slate-900 rounded-lg p-2 text-gray-900 bg-white focus:outline-none focus:border-slate-900 focus:ring-2 focus:ring-slate-200 dark:border-slate-600 dark:bg-slate-950/40 dark:text-slate-100 dark:focus:border-slate-400 dark:focus:ring-slate-500/30"
          >
        ...
        <div>
          ...
          <select
            ...
            className="w-full border-2 border-slate-900 rounded-lg p-2 text-gray-900 font-semibold bg-white focus:outline-none focus:border-slate-900 focus:ring-2 focus:ring-slate-200 dark:border-slate-600 dark:bg-slate-950/40 dark:text-slate-100 dark:focus:border-slate-400 dark:focus:ring-slate-500/30"
          >
