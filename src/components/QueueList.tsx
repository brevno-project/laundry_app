                  ...
                  <div key={item.id} className={`${statusDisplay.bg} border border-slate-200 dark:border-slate-700 border-l-4 ${leftBorderColor} rounded-lg p-3 shadow-sm`}>
                    ...
                    <div className="grid grid-cols-3 gap-2 mb-2 text-sm">
                      <div className="flex flex-col">
                        ...
                        <span className="text-lg font-bold text-gray-900 dark:text-white">{item.wash_count || 1}</span>
                      </div>
                      <div className="flex flex-col">
      ...
      {showEditModal && editingItem && (
        ...
        <div>
          ...
          <select
            ...
            className="w-full border-2 border-slate-900 rounded-lg p-2 text-gray-900 font-semibold bg-white focus:outline-none focus:border-slate-900 dark:border-slate-600 dark:bg-slate-950/40 dark:text-slate-100 dark:focus:border-slate-400"
          >
