...
export type AvatarType = 'default' | 'avatar1' | 'avatar2' | 'avatar3' | 'avatar4' | 'avatar5' | 'avatar6' | 'avatar7' | 'avatar8' | 'avatar9' | 'avatar10' | 'avatar11' | 'avatar12' | 'avatar13' | 'avatar14' | 'avatar15' | 'avatar16' | 'avatar17' | 'avatar18' | 'avatar19' | 'avatar20' | 'avatar21' | 'avatar22' | 'avatar23' | 'avatar24' | 'avatar25' | 'avatar26' | 'avatar27' | 'avatar28' | 'avatar29' | 'avatar30' | 'avatar31' | 'avatar32' | 'avatar33' | 'avatar34' | 'avatar35' | 'avatar36' | 'avatar37' | 'avatar38' | 'avatar39' | 'avatar40';
...
export const AVATAR_OPTIONS: { value: AvatarType; label: string }[] = [
  ...
  { value: 'avatar1', label: 'Аватар 1' },
  { value: 'avatar2', label: 'Аватар 2' },
  { value: 'avatar3', label: 'Аватар 3' },
  { value: 'avatar4', label: 'Аватар 4' },
  { value: 'avatar5', label: 'Аватар 5' },
  { value: 'avatar6', label: 'Аватар 6' },
  { value: 'avatar7', label: 'Аватар 7' },
  { value: 'avatar8', label: 'Аватар 8' },
  { value: 'avatar9', label: 'Аватар 9' },
  { value: 'avatar10', label: 'Аватар 10' },
  { value: 'avatar11', label: 'Аватар 11' },
  { value: 'avatar12', label: 'Аватар 12' },
  { value: 'avatar13', label: 'Аватар 13' },
  { value: 'avatar14', label: 'Аватар 14' },
  { value: 'avatar15', label: 'Аватар 15' },
  { value: 'avatar16', label: 'Аватар 16' },
  { value: 'avatar17', label: 'Аватар 17' },
  { value: 'avatar18', label: 'Аватар 18' },
  { value: 'avatar19', label: 'Аватар 19' },
  { value: 'avatar20', label: 'Аватар 20' },
  { value: 'avatar21', label: 'Аватар 21' },
  { value: 'avatar22', label: 'Аватар 22' },
  { value: 'avatar23', label: 'Аватар 23' },
  { value: 'avatar24', label: 'Аватар 24' },
  { value: 'avatar25', label: 'Аватар 25' },
  { value: 'avatar26', label: 'Аватар 26' },
  { value: 'avatar27', label: 'Аватар 27' },
  { value: 'avatar28', label: 'Аватар 28' },
  { value: 'avatar29', label: 'Аватар 29' },
  { value: 'avatar30', label: 'Аватар 30' },
  { value: 'avatar31', label: 'Аватар 31' },
  { value: 'avatar32', label: 'Аватар 32' },
  { value: 'avatar33', label: 'Аватар 33' },
  { value: 'avatar34', label: 'Аватар 34' },
  { value: 'avatar35', label: 'Аватар 35' },
  { value: 'avatar36', label: 'Аватар 36' },
  { value: 'avatar37', label: 'Аватар 37' },
  { value: 'avatar38', label: 'Аватар 38' },
  { value: 'avatar39', label: 'Аватар 39' },
  { value: 'avatar40', label: 'Аватар 40' },
];

export default function Avatar({ type = 'default', className = 'w-12 h-12' }: AvatarProps) {
  const fullClassName = `${className} text-gray-900`;
  const avatars: Record<AvatarType, ReactElement> = {
    default: (
      <svg className={fullClassName} viewBox="0 0 24 24" fill="currentColor">
    ...
    avatar6: (<svg className={fullClassName} viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="8" r="4.1"/><path d="M12 14c-5.8 0-7.8 2.8-7.8 4.8V20h15.6v-1.2c0-2-2-4.8-7.8-4.8z"/><rect x="10" y="6.2" width="4" height="0.9" fill="white" opacity="0.35"/></svg>),
    avatar7: (<svg className={fullClassName} viewBox="0 0 24 24" fill="currentColor"><ellipse cx="12" cy="8.1" rx="4.2" ry="4"/><path d="M12 14c-5.5 0-7.5 2.7-7.5 4.7V20h15v-1.3c0-2-2-4.7-7.5-4.7z"/><circle cx="10.3" cy="7.7" r="0.45" fill="white"/><circle cx="13.7" cy="7.7" r="0.45" fill="white"/></svg>),
    avatar8: (<svg className={fullClassName} viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="7.9" r="4.4"/><path d="M12 14c-6.1 0-8.1 3.1-8.1 5.1V21h16.2v-1.9c0-2-2-5.1-8.1-5.1z"/><path d="M9 5.8h6v1.1H9z" fill="white" opacity="0.38"/></svg>),
    avatar9: (<svg className={fullClassName} viewBox="0 0 24 24" fill="currentColor"><ellipse cx="12" cy="8" rx="4.3" ry="4.6"/><path d="M12 14c-5.9 0-7.9 2.9-7.9 4.9V20h15.8v-1.1c0-2-2-4.9-7.9-4.9z"/><rect x="9.8" y="6.4" width="4.4" height="0.85" rx="0.3" fill="white" opacity="0.32"/></svg>),
    avatar10: (<svg className={fullClassName} viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="8.2" r="4.35"/><path d="M12 14c-5.7 0-7.7 2.6-7.7 4.6V20h15.4v-1.4c0-2-2-4.6-7.7-4.6z"/><circle cx="10.4" cy="7.9" r="0.48" fill="white"/><circle cx="13.6" cy="7.9" r="0.48" fill="white"/><path d="M9.2 6h5.6v0.7H9.2z" fill="white" opacity="0.36"/></svg>),
    avatar11: (<svg className={fullClassName} viewBox="0 0 24 24" fill="currentColor"><path d="M12 3.8c-2.6 0-4.6 2.1-4.6 4.6S9.4 13 12 13s4.6-2.1 4.6-4.6S14.6 3.8 12 3.8z"/><path d="M12 14c-6.15 0-8.15 3.15-8.15 5.15V21h16.3v-1.85c0-2-2-5.15-8.15-5.15z"/><rect x="10.2" y="6.8" width="3.6" height="0.75" fill="white" opacity="0.42"/></svg>),
    avatar12: (<svg className={fullClassName} viewBox="0 0 24 24" fill="currentColor"><ellipse cx="12" cy="8.15" rx="4.15" ry="4.3"/><path d="M12 14c-5.65 0-7.65 2.75-7.65 4.75V20h15.3v-1.25c0-2-2-4.75-7.65-4.75z"/><circle cx="10.35" cy="7.85" r="0.52" fill="white"/><circle cx="13.65" cy="7.85" r="0.52" fill="white"/></svg>),
    avatar13: (<svg className={fullClassName} viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="8.05" r="4.25"/><path d="M12 14c-5.85 0-7.85 2.85-7.85 4.85V20h15.7v-1.15c0-2-2-4.85-7.85-4.85z"/><path d="M8.9 5.9c0.6-0.9 1.6-1.6 3.1-1.6s2.5 0.7 3.1 1.6" stroke="white" strokeWidth="0.55" fill="none" opacity="0.45"/></svg>),
    avatar14: (<svg className={fullClassName} viewBox="0 0 24 24" fill="currentColor"><ellipse cx="12" cy="8" rx="4.05" ry="4.55"/><path d="M12 14c-5.75 0-7.75 2.65-7.75 4.65V20h15.5v-1.35c0-2-2-4.65-7.75-4.65z"/><rect x="10.1" y="6.6" width="3.8" height="0.8" rx="0.35" fill="white" opacity="0.34"/></svg>),
    avatar15: (<svg className={fullClassName} viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="7.95" r="4.38"/><path d="M12 14c-6.05 0-8.05 3.05-8.05 5.05V21h16.1v-1.95c0-2-2-5.05-8.05-5.05z"/><circle cx="10.25" cy="7.75" r="0.5" fill="white"/><circle cx="13.75" cy="7.75" r="0.5" fill="white"/><path d="M9.5 6.1h5v0.75h-5z" fill="white" opacity="0.39"/></svg>),
    avatar16: (<svg className={fullClassName} viewBox="0 0 24 24" fill="currentColor"><path d="M12 3.9c-2.55 0-4.55 2.05-4.55 4.55S9.45 13 12 13s4.55-2.05 4.55-4.55S14.55 3.9 12 3.9z"/><path d="M12 14c-6.2 0-8.2 3.2-8.2 5.2V21h16.4v-1.8c0-2-2-5.2-8.2-5.2z"/><ellipse cx="10.2" cy="7.6" rx="0.85" ry="1.05" fill="white" opacity="0.65"/><ellipse cx="13.8" cy="7.6" rx="0.85" ry="1.05" fill="white" opacity="0.65"/></svg>),
    avatar17: (<svg className={fullClassName} viewBox="0 0 24 24" fill="currentColor"><ellipse cx="12" cy="8.1" rx="4.25" ry="4.1"/><path d="M12 14c-5.95 0-7.95 2.95-7.95 4.95V20h15.9v-1.05c0-2-2-4.95-7.95-4.95z"/><path d="M8.8 5.7c0.65-0.85 1.65-1.55 3.2-1.55s2.55 0.7 3.2 1.55" stroke="white" strokeWidth="0.6" fill="none" opacity="0.43"/><rect x="10.3" y="7.1" width="3.4" height="0.7" fill="white" opacity="0.48"/></svg>),
    avatar18: (<svg className={fullClassName} viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="8.08" r="4.32"/><path d="M12 14c-5.88 0-7.88 2.88-7.88 4.88V20h15.76v-1.12c0-2-2-4.88-7.88-4.88z"/><circle cx="10.32" cy="7.82" r="0.46" fill="white"/><circle cx="13.68" cy="7.82" r="0.46" fill="white"/></svg>),
    avatar19: (<svg className={fullClassName} viewBox="0 0 24 24" fill="currentColor"><ellipse cx="12" cy="8" rx="4.18" ry="4.48"/><path d="M12 14c-6.08 0-8.08 3.08-8.08 5.08V21h16.16v-1.92c0-2-2-5.08-8.08-5.08z"/><path d="M9.1 6.2h5.8v0.9H9.1z" fill="white" opacity="0.37"/></svg>),
    avatar20: (<svg className={fullClassName} viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="8.12" r="4.28"/><path d="M12 14c-5.82 0-7.82 2.82-7.82 4.82V20h15.64v-1.18c0-2-2-4.82-7.82-4.82z"/><rect x="10.15" y="6.7" width="3.7" height="0.82" rx="0.38" fill="white" opacity="0.33"/><circle cx="10.38" cy="7.88" r="0.44" fill="white"/><circle cx="13.62" cy="7.88" r="0.44" fill="white"/></svg>),
    avatar21: (
      <svg className={fullClassName} viewBox="0 0 24 24" fill="currentColor">
        <circle cx="12" cy="8" r="4"/>
        <path d="M12 14c-6 0-8 3-8 5v1h16v-1c0-2-2-5-8-5z"/>
