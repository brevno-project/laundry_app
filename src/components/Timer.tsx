...
const TIME_ZONES = {
  yellow: { warning: 10, danger: 20 },   // Идет за ключом: 5-15 мин, >15 мин
  blue: { warning: 10, danger: 20 },     // Ключ выдан: 5-10 мин, >10 мин
  green: { warning: 100, danger: 120 },  // Стирает: 90-120 мин, >120 мин
  orange: { warning: 10, danger: 20 },   // Возвращает ключ: 5-10 мин, >10 мин
};
...
export default function Timer({ startTime, endTime, label, color = 'blue', multiplier = 1 }: TimerProps) {
  ...
  const baseColors = {
    ...
    blue: { bg: 'bg-blue-50 dark:bg-blue-950/35', text: 'text-blue-800 dark:text-blue-100', border: 'border-blue-500 dark:border-blue-400/70' },
